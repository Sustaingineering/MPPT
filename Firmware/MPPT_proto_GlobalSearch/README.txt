This project contains code to run either the " Modified Perturb and Observe" or "Modified Incremental Conductance"
algorithm on a Ti Piccolo F2802x series microcontroller. See the comments in the code to gain an understanding of the program.
